...
<style>
    ...
    .step-num {
        ...
        color: #3B82F6; margin: 0 auto 0.4rem;
    }
    ...
    .pill-green {
        ...
        padding: 0.2rem 0.65rem; font-size: 0.72rem;
...
if analyse:
    if not jd_input:
        ...
        with st.spinner("Analysing your resume..."):
            ...
            score = get_match_score(jd_clean, resume_clean)
